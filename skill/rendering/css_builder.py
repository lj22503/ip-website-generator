...
DESIGN_SPECS = {
    ...
    "ollama": {
        "fonts": {
            ...
            "mono": "JetBrains Mono",
            "google_link": "https://fonts.googleapis.com/css2?family=JetBrains+Mono:wght@300;400;500;600;700&family=JetBrains+Mono:wght@400;500&display=swap",
        },
        "colors": {
            "bg": "#1a1a1a",
            "bg_secondary": "#1a1a1a",
    ...
    "sentry": {
        "fonts": {
            "primary": "Rubik",
            "mono": "JetBrains Mono",
            "google_link": "https://fonts.googleapis.com/css2?family=Rubik:wght@300;400;500;600;700&family=JetBrains+Mono:wght@400;500&display=swap",
        },
        "colors": {
            "bg": "#1a1a2e",
            "bg_secondary": "#1a1a2e",
    ...
    "cal.com": {
        "fonts": {
            "primary": "Inter",
            "mono": "Inter",
            "google_link": "https://fonts.googleapis.com/css2?family=Inter:wght@300;400;500;600;700&family=Inter:wght@400;500&display=swap",
        },
        "colors": {
            "bg": "#ffffff",
            "bg_secondary": "#f5f5f5",
    ...
    "sanity": {
        "fonts": {
            ...
            "mono": "JetBrains Mono",
            "google_link": "https://fonts.googleapis.com/css2?family=Space+Grotesk:wght@300;400;500;600;700&family=JetBrains+Mono:wght@400;500&display=swap",
        },
        "colors": {
            "bg": "#ffffff",
            "bg_secondary": "#f5f5f5",
