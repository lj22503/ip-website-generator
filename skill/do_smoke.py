"""Run smoke test and write results to JSON file."""
import sys, os, json
...
try:
    ...
    results.append(('FAIL', f'developerfolio exception: {e}'))
...
try:
    ...
    results.append(('FAIL', f'alfolio exception: {e}'))
...
try:
    ...
    results.append(('FAIL', f'rahulbeniwal exception: {e}'))
...
with open(os.path.join(out_dir, 'smoke_summary.txt'), 'w', encoding='utf-8') as f:
